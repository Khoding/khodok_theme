		...
		<div id="content" class="site-content flex-grow">
			...
			<?php if (is_front_page()) : ?>
				<div class="container mx-auto my-12 border-b pb-12">
					...
					<h2 class="text-3xl lg:text-7xl tracking-tight font-extrabold my-4">This is a sample test WordPress theme by <a href="https://www.khodok.xyz/" class="text-primary">Khodok</a>.</h2>
