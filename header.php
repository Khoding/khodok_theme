...
<body <?php body_class('bg-white dark:bg-gray-800 dark:text-gray-100'); ?>>

	<?php do_action('khodok_theme_site_before'); ?>

	<div id="page" class="min-h-screen flex flex-col">

		<?php do_action('khodok_theme_header'); ?>
		...
		<div id="content" class="site-content flex-grow">
			...
			<?php if (is_front_page()) : ?>
				<div class="container mx-auto my-12 border-b pb-12">
					...
					<h2 class="text-3xl lg:text-7xl tracking-tight font-extrabold my-4">This is a sample test WordPress theme by
						with <a href="https://www.khodok.xyz/" class="text-primary">Khodok</a>.</h2>
